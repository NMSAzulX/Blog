! function () {
        ...
        var canvas = {
            elem: document.querySelector('#tree-canvas'),
            width: 0,
            height: 0,
            resize: function () {
        ...
        canvas.elem.setAttribute("width",document.body.offsetWidth);
        canvas.elem.setAttribute("height",document.body.clientHeight);
        ...
        window.addEventListener("mousemove", pointer.move.bind(pointer), true);
        canvas.elem.addEventListener("touchmove", pointer.move.bind(pointer), true );
